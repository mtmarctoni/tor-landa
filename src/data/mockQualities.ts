...
/**
 * Mock data for quality messages used when Notion is not configured
 * This provides demonstration content for development and testing
 */
export const mockQualities: QualityEntry[] = [
  {
    week: 1,
    year: 2024,
    message:
