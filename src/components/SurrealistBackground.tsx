    ...
    return (
        <>
            ...
            <div className="absolute inset-0 opacity-24 sm:opacity-30">
                ...
                <div className="absolute right-2 top-44 h-36 w-36 rounded-full bg-dream-300 blur-2xl sm:right-20 sm:top-40 sm:h-60 sm:w-60 sm:animate-drift" style={{ animationDelay: '-5s' }}></div>
                <div className="absolute bottom-28 left-1/2 h-28 w-28 -translate-x-1/2 rounded-full bg-dream-400 blur-2xl sm:bottom-20 sm:h-40 sm:w-40 sm:animate-drift" style={{ animationDelay: '-10s' }}></div>
            </div>
        </>
    );
}
