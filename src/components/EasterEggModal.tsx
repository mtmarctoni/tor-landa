  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-dream-700 mb-2">
          ¡Sorpresa Surrealista!
        </h2>
        <p className="text-dream-800 mb-4 text-center">
          Esta sorpresa es para ti, de alguien que te quiere mucho. A veces el
          cariño no se ve, pero siempre está contigo, incluso en los momentos
          más simples.
        </p>
        <button
          type="button"
